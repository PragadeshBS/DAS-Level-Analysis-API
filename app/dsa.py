...
depressionModel = keras.models.load_model(
    'app/deployables/depression.h5', custom_objects={"coeff_determination": coeff_determination})
anxietyModel = keras.models.load_model(
    'app/deployables/anxiety.h5', custom_objects={"coeff_determination": coeff_determination})
stressModel = keras.models.load_model(
    'app/deployables/stress.h5', custom_objects={"coeff_determination": coeff_determination})
